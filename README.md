...
- A Windows version is not planned. This project is macOS-only because I only have access to macOS and do not have experience building or maintaining Windows desktop apps.
